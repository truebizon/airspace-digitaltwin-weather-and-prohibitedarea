...
/**
 * 局地数値予報モデルで提供する情報のYAML(provide-content.lfm).
 *
 * @author isao.kaneko
 */
@ConfigurationProperties(prefix = "provide-content.lfm")
@Validated
@Getter
public class ProvideContentLfmYml implements ProvideContent {
     ...
     */
    public ProvideContentLfmYml(List<String> areaCsvs, int minForecastTime,
