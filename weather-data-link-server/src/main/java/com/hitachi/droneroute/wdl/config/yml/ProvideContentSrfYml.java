...
/**
 * 降水量短時間予報で提供する情報のYAML(provide-content.srf).
 *
 * @author isao.kaneko
 */
@ConfigurationProperties(prefix = "provide-content.srf")
@Validated
@Getter
public class ProvideContentSrfYml implements ProvideContent {
     ...
     */
    public ProvideContentSrfYml(List<String> areaCsvs, int minForecastTime,
